...
window.sendMessage = function() {
  ...
  botReply = 'Ya, kami menghadirkan insight mendalam yang juga menarik untuk investor berpengalaman.';
    ...
    botReply = 'Wah, aku belum punya info itu. Coba diliat di bagian info lomba dan seminar, dan jika masih ada yang ingin ditanyakan bisa menghubungi nomor yang tertera ya!';
  }
  setTimeout(() => {
